...
public enum Fixtures {
    ...
    public static let loginSession = """
    ...
    /// Seed a canonical active medication (state-table row) for DB-backed tests.
    public static func sampleMedication(id: String = "m1", userId: String = "u1") -> Medication {
        Medication(
            id: id, userId: userId, name: "Med", dosageAmount: "50", dosageUnit: "mg",
