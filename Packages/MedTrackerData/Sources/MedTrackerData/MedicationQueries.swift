...
public extension Medication {
    ...
    internal static func fetchOwned(_ db: Database, userId: String, id: String) throws -> Medication? {
    ...
    static func fetchActive(_ db: Database, userId: String) throws -> [Medication] {
        try Medication
...
public extension MedicationSchedule {
...
public extension InventoryEvent {
    ...
    static func history(_ db: Database, userId: String, medicationId: String) throws -> [InventoryEvent] {
        try InventoryEvent
            .filter(Column("user_id") == userId)
